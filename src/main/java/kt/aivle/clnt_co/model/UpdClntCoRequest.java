...
public class UpdClntCoRequest extends BaseModel {
  private static final long serialVersionUID = 1L;

  /**
   * 의뢰사고유번호
   */
  @NotBlank(message = "의뢰사고유번호는 필수입니다.")
  @ApiModelProperty(required = true, notes = "의뢰사고유번호", position = 1)
   ...
   * 거래여부
   */
  @ApiModelProperty(required = false, notes = "거래여부", position = 13)
